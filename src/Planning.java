...
public class Planning {
    ...
    public static void inputTask(Scanner scanner) {
        try {
            ...
            Repeatable.TaskType tasktype = Repeatable.TaskType.values()[scanner.nextInt()];
    ...
    public static void createEvent(Scanner scanner, String name, String description, Repeatable.TaskType tasktype, int duration) {
        try {
    ...
    private static Repeatable createTask(int duration, String name, String description, Repeatable.TaskType taskType, LocalDateTime localDateTime) throws WrongInputException {
        return switch (duration) {
            ...
            case 1 -> {
                Objective.DailyO task = new Objective.DailyO(name, description, taskType, localDateTime);
